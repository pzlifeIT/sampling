  ...
  <div class="bg">
    <div class="cont">
      ...
      <div class="input">
        <!--<van-field v-model="cardNum" label="卡号" border />-->
        <label>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</label>
        <input v-model="sex" @focus="change('sex')" class="inp" placeholder="请选择"/>
  ...
  export default {
    ...
    data() {
      return {
        ...
        areaVal: '',
        cardNum: '',
        sampling: [{value: 1, text: '222'}, {value: 2, text: '333'}],
        area: [],
        sampAdd: '',
        project_id: [],
        sexCode: '',
    ...
    methods: {
      ...
      confirm(value) {
        ...
        if (this.type == 'zl') {
          this.zlTime = d.getFullYear() + '年' + (d.getMonth() + 1) + '月'
        }
      },
      confirmStart(value){
        let d = new Date(value)
        ...
        this.start = d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + ' ' + d.getHours()+':00:00'
      },
      cancel() {
        this.dateState = false
        this.pop = false
